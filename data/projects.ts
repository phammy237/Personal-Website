...
export const projects: Project[] = [
  {
    ...
    description: "A Chrome extension designed to reduce impulse spending by surfacing real-time budget impact, savings-goal delay, and lower-cost alternatives at the point of purchase. Built at SASE Hacks 2026, winning Best Finance Project.",
    bullets: [
      "Contributed to backend and product logic using FastAPI (fully async), MongoDB via Motor, and Gemini 2.5 Flash for AI-powered recommendations.",
      "Supported personalized financial recommendations, user behavior tracking, and dashboard insights.",
      "Built eBay alternative scraping with Playwright and a Manifest V3 Chrome extension frontend in React + TypeScript + Tailwind CSS + Vite.",
    ],
  ...
  },
  {
    ...
    description: "A gamified pediatric health app architecting measurement systems capturing 1,000+ interaction data points per session across cognitive, motor, and behavioral signals. Built at Code4Change, placing 3rd Overall.",
    bullets: [
      ...
      "Built as a monorepo (Turborepo + pnpm workspaces) with React Native + Expo iPad app, Express + PostgreSQL (Knex) API, and React 19 + Vite + Tailwind CSS 4 dashboard.",
    ],
...
export const competitions: Project[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Identified that detection benefits increase with group size but show diminishing returns, with moderate groups of about 3–5 species providing the strongest advantage before saturation.",
  ...
  },
  {
    ...
    bullets: [
      "Evaluated 4 strategic scenarios and projected $56M–$79M season profit range via 200-trial Monte Carlo risk analysis.",
