export function JourneyProgress({ index, total }: { index: number; total: number }) {
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-border bg-white/90 px-4 py-2 shadow-sm backdrop-blur dark:border-white/10 dark:bg-[#12101F]/90">
