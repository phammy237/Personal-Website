...
export function PinLabel({
  ...
  return (
    <button
      ...
      className={`absolute z-10 max-w-[160px] rounded-xl border bg-white/95 px-3 py-2 text-left shadow-md backdrop-blur transition-all duration-200 dark:bg-[#12101F]/95 ${
